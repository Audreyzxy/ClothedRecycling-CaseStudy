                ...
                <div>
                    <asp:GridView ID="gvManageDonations" runat="server" CaptionAlign="Top"
                        ...
                        EmptyDataText="There Are No Donations"
                         OnRowEditing="gvManageDonations_RowEditing"
                         OnRowUpdating="gvManageDonations_RowUpdating" 
                        OnRowDeleting="gvManageDonations_RowDeleting" OnRowCancelingEdit="gvManageDonations_RowCancelingEdit">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Beneficiery">
                                ...
                                <EditItemTemplate>
                                   <%-- <asp:DropDownList ID="ddlRecipient" CssClass="form-control" runat="server" 
                                        DataSourceID="RecipientDataSource" AppendDataBoundItems="true" DataTextField="CharityName" 
                                        DataValueField="RecipientId">--%>
                                        <%--SelectedValue='<%# ProcessDataItem(Eval("RecipientId")) %>' --%>
                                       <%-- <asp:ListItem Value="-1">Select</asp:ListItem>
                                    </asp:DropDownList>--%>
                                    <asp:DropDownList ID="ddlRecipient" CssClass="form-control" onchange="SetStatusValue(this)" 
                                        AppendDataBoundItems="true" runat="server" 
                                        PreviousValue='<%# Eval("RecipientId") %>' SelectedValue='<%# Bind("RecipientId") %>' 
                                        DataTextField="CharityName" DataValueField="RecipientId" DataSourceID="RecipientDataSource">
